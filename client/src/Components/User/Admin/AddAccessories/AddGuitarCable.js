...
import { addGuitarCable } from './../../../../store/actions/accessories_action/cable_action';

class AddGuitarCable extends Component {
    state={
        formError:false,
        formSuccess:false,
        formdata:{
    ...
    submitForm = (event)=>{
        ...
        if(formIsValid){
            this.props.dispatch(addGuitarCable(dataToSubmit))
            .then(()=>{
                if(this.props.accessories.addGuitarCable.success){
    ...
    render() {
        return (
            <UserLayout>
                <div>
                    <h1>Add Accessories/Guitar Cable</h1>
...
export default connect(mapStateToProps)(AddGuitarCable);