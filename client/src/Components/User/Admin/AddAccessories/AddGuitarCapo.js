...
import { addGuitarCapo } from './../../../../store/actions/accessories_action/capo_action';

class AddGuitarCapo extends Component {
    state={
        formError:false,
        formSuccess:false,
        formdata:{
    ...
    submitForm = (event)=>{
        ...
        if(formIsValid){
            this.props.dispatch(addGuitarCapo(dataToSubmit))
            .then(()=>{
                if(this.props.accessories.addGuitarCapo.success){
    ...
    render() {
        return (
            <UserLayout>
                <div>
                    <h1>Add Accessories/Guitar Capo</h1>
...
export default connect(mapStateToProps)(AddGuitarCapo);