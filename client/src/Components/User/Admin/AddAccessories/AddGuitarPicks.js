...
import { addGuitarPick } from './../../../../store/actions/accessories_action/pick_action';

class AddGuitarPicks extends Component {
    state={
        formError:false,
        formSuccess:false,
        formdata:{
    ...
    submitForm = (event)=>{
        ...
        if(formIsValid){
            this.props.dispatch(addGuitarPick(dataToSubmit))
            .then(()=>{
                if(this.props.accessories.addGuitarPick.success){
    ...
    render() {
        return (
            <UserLayout>
                <div>
                    <h1>Add Accessories/Guitar Picks</h1>
...
export default connect(mapStateToProps)(AddGuitarPicks);