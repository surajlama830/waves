...
import { addGuitarStand } from './../../../../store/actions/accessories_action/stand_action';

class AddGuitarStand extends Component {
    state={
        formError:false,
        formSuccess:false,
        formdata:{
    ...
    submitForm = (event)=>{
        ...
        if(formIsValid){
            this.props.dispatch(addGuitarStand(dataToSubmit))
            .then(()=>{
                if(this.props.accessories.addGuitarStand.success){
    ...
    render() {
        return (
            <UserLayout>
                <div>
                    <h1>Add Accessories/Guitar Stand</h1>
...
export default connect(mapStateToProps)(AddGuitarStand);