...
import { addGuitarString } from '../../../../store/actions/accessories_action/string_action';
...
class AddString extends Component {
    ...
    submitForm = (event)=>{
        ...
        if(formIsValid){
            this.props.dispatch(addGuitarString(dataToSubmit))
            .then(()=>{
                if(this.props.accessories.addGuitarString.success){
    ...
    render() {
        return (
            <UserLayout>
                <div>
                    <h1>Add Accessories/Guitar String</h1>
...
export default connect(mapStateToProps)(AddString);